...
public class Main {
    ...
    // VARIABLES GLOBALES
    public static String nombres = "Alejandra Maria";
    public static String apellidos = "Marquez Lopez";
    public static int anio_nacimiento = 2004;
    public static int mes_nacimiento = 8;
    public static float estatura = 1.53f; //ESTATURA EN METROS
    public static float peso = 130.9f; // PESO EN LIBRAS
    ...
    public static void main(String[] args) {
        ...
        int dias_laborales = 22; // 22 HORAS LABORALES AL MES
        ...
        // CONVERTIR EL VALOR DE LA ESTATURA AL CUADRADO
